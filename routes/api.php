...
use App\Http\Controllers\Api\V2\CarrierController;
...
use App\Http\Controllers\Api\V2\CustomerProductController;
...
use App\Http\Controllers\Api\V2\OnlinePaymentController;
...
use App\Http\Controllers\Api\V2\WholesaleProductController;
...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function () {
    ...
    Route::post('/newsletter', [NewsletterController::class, 'emailstore']);
    ...
    Route::controller(CustomerProductController::class)->group(function () {
     ...
     Route::controller(ProductController::class)->group(function () {
        ...
        Route::get('related-products/{slug}', 'relatedProducts');
    ...
    Route::apiResource('products', 'App\Http\Controllers\Api\V2\ProductController')->except(['store', 'update', 'destroy','show']);

    Route::get('products/{slug}',  'App\Http\Controllers\Api\V2\ProductController@product_details')->name('products.show');
    ...
    Route::get('areas', 'App\Http\Controllers\Api\V2\AddressController@getAreas');
    ...
    Route::controller(CommentController::class)->group(function () {
        ...
        Route::get('blog/{slug}/comments', 'comments');
        Route::put('blog/comment/{id}', 'update');
