...
<header
    ...
    <div class="position-relative logo-bar-area border-bottom border-md-nonea z-1025">
        <div class="container">
            <div class="d-flex align-items-center">
                ...
                <div class="col-3 mt-2 ml-auto text-right">
                      Hotline:
    <a href="tel:01777494871" style="color:#6bb5f5; text-decoration:none; padding-left: 5px">
        01777494871
    </a>
    ...
    <!-- Menu Bar -->
    <div class="d-none d-lg-block position-relative h-50px bottom-background-color-visibility border-bottom" style="background-color: {{ get_setting('bottom_header_bg_color') }};box-shadow: 0 8px 8px rgba(0, 0, 0, 0.05); font-size:20px;">
                        ...
                        <ul class="list-inline mb-0 pl-0 hor-swipe c-scrollbar-light" >
                            ...
                            <li class="list-inline-item mr-0 animate-underline-white">
                                <a href="{{ json_decode(get_setting('header_menu_links'), true)[$key] }}"
                                    class="fs-16 px-3 py-3 d-inline-block fw-700 header_menu_links hov-bg-black-10 bottom-text-color-visibility @if (url()->current() == json_decode(get_setting('header_menu_links'), true)[$key]) active @endif" style="color: {{ $bottomHeaderTextColor }}">
                                    {{ translate($value) }}
                                </a>
                            </li>
                            @endforeach
